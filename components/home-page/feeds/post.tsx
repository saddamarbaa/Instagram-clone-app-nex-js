...
const Post: React.FunctionComponent<PostType> = React.forwardRef(
	(props, ref: any) => {
		const { postContent, postImage, postDate, userName, userImage } = props;
		...
		return (
			<div
				ref={ref}
				className='mt-[1.5rem] bg-white shadow-sm   max-w-[616px] overflow-hidden py-4 border  rounded-[5px] '>
